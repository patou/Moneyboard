...
public interface BlueButtonTableFrameResources extends TableFrameResources, ClientBundle {
  
  @Source({"com/sencha/gxt/theme/base/client/frame/TableFrame.css", "BlueButtonTableFrame.css"})
  @Override
